...
> **Operating the Atlas ticket agent system?** See
> [`atlas/AGENTS.md`](atlas/AGENTS.md) — it covers Atlas-specific rules
> (tmux pane safety, the agent pool, boss control) and points to
