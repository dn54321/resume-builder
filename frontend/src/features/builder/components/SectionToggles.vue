  ...
  <div class="section-toggles">
    ...
    <ul class="section-toggles__list">
      <li
        ...
        :class="{ 'section-toggles__item--selected': section.type === selectedSectionId }"
        @click="emit('selectSection', section.type)"
      >
        <label class="section-toggles__toggle" @click.stop>
          <input
            type="checkbox"
...
const emit = defineEmits<{
  ...
  selectSection: [sectionType: SectionType]
}>()
...
.section-toggles__item:hover {
  background: var(--color-background-muted, #e5e7eb);
}

.section-toggles__item--selected {
