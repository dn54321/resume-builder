<template>
  <div class="p-4">
    <h3 class="text-base font-semibold m-0 mb-4 text-gray-900">Name &amp; Contact</h3>
    <div class="flex flex-col gap-3">
      <div class="flex flex-col gap-1">
        <label class="text-[0.8125rem] font-medium text-gray-900" for="nc-full-name">Full Name <span class="text-red-600">*</span></label>
        <input
          id="nc-full-name"
          type="text"
          :value="fieldValue('fullName')"
          @input="update('fullName', ($event.target as HTMLInputElement).value)"
          class="px-3 py-2 border border-gray-300 rounded-md text-sm font-[inherit] text-gray-900 bg-white focus:outline-hidden focus:border-blue-500 focus:ring-1 focus:ring-blue-500 invalid:border-red-600"
          placeholder="John Doe"
          required
        />
      </div>
      <div class="flex flex-col gap-1">
        <label class="text-[0.8125rem] font-medium text-gray-900" for="nc-email">Email</label>
        <input
          id="nc-email"
          type="email"
      ...
      <div class="flex flex-col gap-1">
        <label class="text-[0.8125rem] font-medium text-gray-900" for="nc-phone">Phone</label>
        <input
          id="nc-phone"
          type="tel"
      ...
      <div class="flex flex-col gap-1">
        <label class="text-[0.8125rem] font-medium text-gray-900" for="nc-location">Location</label>
        <input
          id="nc-location"
          type="text"
      ...
      <div class="flex flex-col gap-1">
        <label class="text-[0.8125rem] font-medium text-gray-900" for="nc-linkedin">LinkedIn URL</label>
        <input
          id="nc-linkedin"
          type="url"
      ...
      <div class="flex flex-col gap-1">
        <label class="text-[0.8125rem] font-medium text-gray-900" for="nc-website">Website</label>
        <input
          id="nc-website"
          type="url"
